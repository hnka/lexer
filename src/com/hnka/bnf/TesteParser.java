...
public class TesteParser extends Parser {
	...
	public static class RContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof TesteListener ) ((TesteListener)listener).enterR(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof TesteListener ) ((TesteListener)listener).exitR(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TesteVisitor ) return ((TesteVisitor<? extends T>)visitor).visitR(this);
